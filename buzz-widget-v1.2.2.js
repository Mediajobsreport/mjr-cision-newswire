/* MJR Buzz Widget v1.2.2 — natural image layout + Cision copyright */
(function () {
  "use strict";
  ...
  function renderList() {
    ...
    root.querySelectorAll("[data-release-id]").forEach(function (button) {
      button.addEventListener("click", function () {
        openArticle(button.getAttribute("data-release-id"));
      });
    });
    ...
    return '<article class="mjr-buzz-card' + (image ? '' : ' mjr-buzz-card--no-image') + '">' +
      ...
      '<div class="mjr-buzz-card-body">' +
        ...
        '<h2 class="mjr-buzz-title">' +
          '<button class="mjr-buzz-title-button" type="button" data-release-id="' +
        ...
        '<button class="mjr-buzz-read" type="button" data-release-id="' +
        escapeAttr(release.release_id) +
